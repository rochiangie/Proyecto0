...
class CultivoApp:
    ...
    def configurar_interfaz(self):
        ...
        # Añadir Calendario
        self.calendario = Calendar(self.root, selectmode='day', year=2024, month=5, day=30)
        self.calendario.grid(row=5, column=0, columnspan=2, pady=10)

        # Botón para registrar datos
        boton_registrar_datos = tk.Button(self.root, text="Registrar Datos", command=self.registrar_datos)
        boton_registrar_datos.grid(row=6, column=0, columnspan=2, pady=10)

        # Botón para mostrar gráficos
        boton_mostrar_graficos = tk.Button(self.root, text="Mostrar Gráficos", command=self.mostrar_graficos)
