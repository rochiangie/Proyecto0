...
class CultivoApp:
    ...
    def mostrar_graficos(self):
        ...
        axs[0, 0].plot(fechas, temperaturas, marker='o')
        axs[0, 0].set(xlabel='Fecha', ylabel='Temperatura (°C)', title='Temperatura a lo largo del tiempo')
        axs[0, 0].grid()

        # Gráfico de Crecimiento
        axs[0, 1].plot(fechas, crecimiento, marker='o', linestyle='-', color='orange')
        axs[0, 1].set(xlabel='Fecha', ylabel='Crecimiento', title='Crecimiento a lo largo del tiempo')
        axs[0, 1].grid()

        # Gráfico de Floración
        axs[1, 0].plot(fechas, floracion, marker='o', linestyle='-', color='green')
        axs[1, 0].set(xlabel='Fecha', ylabel='Floración', title='Floración a lo largo del tiempo')
        axs[1, 0].grid()

        # Gráfico de Sustrato
        axs[1, 1].plot(fechas, sustrato, marker='o', linestyle='-', color='red')
        axs[1, 1].set(xlabel='Fecha', ylabel='Sustrato', title='Sustrato a lo largo del tiempo')
        axs[1, 1].grid()
